...
// node_modules/.pnpm/@opennextjs+cloudflare@1.14.9_next@16.1.4_@babel+core@7.28.6_babel-plugin-react-compile_f577acd93a41419374f4d60425f308c7/node_modules/@opennextjs/cloudflare/dist/api/durable-objects/queue.js
...
var DOQueueHandler = class extends DurableObject {
    ...
    try {
      ...
      response = await this.service.fetch(`${protocol}://${host}${url}`, {
        ...
        headers: {
          ...
          "x-prerender-revalidate": "17c6ce92fc61174fcc8991695f525cac",
          "x-isr": "1"
        },
  ...
  async addToFailedState(msg) {
    ...
    if (!this.disableSQLite) {
      this.sql.exec("INSERT OR REPLACE INTO failed_state (id, data, buildId) VALUES (?, ?, ?)", msg.MessageDeduplicationId, JSON.stringify(updatedFailedState), "mg-S5vmo0P6LV0plztixB");
    }
    await this.addAlarm();
  }
  async addAlarm() {
  ...
  async initState() {
    ...
    this.sql.exec("DELETE FROM failed_state WHERE buildId != ?", "mg-S5vmo0P6LV0plztixB");
    this.sql.exec("DELETE FROM sync WHERE buildId != ?", "mg-S5vmo0P6LV0plztixB");
